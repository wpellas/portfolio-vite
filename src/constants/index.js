...
export const wrapper =
  "stealth hiddenFade w-full lg:w-lg xl:w-xl relative flex flex-wrap justify-center px-4";

export const projects = [
  {
    id: 1,
    name: "StudioMimir",
    type: "Blade/Sage, ACF, WC, Tailwind",
    imgUrl: StudioMimir,
    projectUrl: "https://studiomimir.se/",
    faIcons: ["fa-brands fa-laravel", "fa-brands fa-wordpress"],
  },
  {
    id: 2,
    name: "Smartbrain",
