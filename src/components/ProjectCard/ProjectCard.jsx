...
const ProjectCard = ({ id, projectName, type, imgUrl, projectUrl, faIcons }) => (
        <div className="stealth hiddenSlide project">
            ...
            <div key={id} className="w-[7.5rem] sm:w-40 md:w-48 lg:w-64 xl:w-72 h-[7.5rem] sm:h-40 md:h-48 lg:h-64 xl:h-72 border-2 border-solid border-cyan-300 rounded-lg shadow shadow-cyan-500 bg-cover hover:border-amber-300 hover:shadow-amber-500">
